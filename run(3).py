...
class CharSprites(pygame.sprite.Sprite):
    ...
    def __init__(self, fileName, location, charWidth, charHeight):
...
class SketchyQuest(PygameGame):
    def __init__(self):
        ...
        self.mainChar = CharSprites("characterDude(COLOURED).png", (21, 465), 73, 162)
        self.scrollX = 0
        self.scrollSpeed = 0
        ...
        # game states
        self.gameScreen = pygame.image.load("nextTestStage copy 2.png")
    ...
    def redrawAll(self, screen):
        ...
        # game screen
            ...
            self.screen.blit(self.gameScreen, (0 - self.scrollX, 0))
            # sketches
